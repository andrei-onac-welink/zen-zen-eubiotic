...
description: 'Descoperă Eubiotic Forte, o combinație de microorganisme vii pentru susținerea tranzitului intestinal și echilibrarea microbiotei.'
slug: '/eubiotic-forte/'
weight: 2
ean: ''
resources:
...
blocks:
  - component: 'hero'
    title: 'Eubiotic Forte'
    productName: 'Eubiotic<sup>®</sup> Forte'
  ...
  - component: 'details'
    ...
    paragraphs:
      ...
      - 'Microbiota este un ecosistem reactiv, inclusiv în fața intervențiilor farmacologice. Antibioterapia are și ea efecte în ceea ce privește modificarea profilului microflorei intestinale. Antibioticele pot perturba echilibrul care există în mod natural între diferitele specii ale microbiotei intestinale.'
    cards:
      - title: 'Alte cauze ale dezechilibrului microflorei intestinale pot fi:'
        items:
          - 'Infecțiile enterale virale sau bacteriene'
          - 'Schimbarea mediului bacterian (călătorii)'
          - 'Tratamentul cu antibiotice'
          - 'Dietele neadecvate'
      - title: 'Dezechilibrul microflorei intestinale/microbiotei poate avea ca forme de manifestare observabile:'
        items:
          - 'Diareea'
  ...
  - component: 'ingredients'
    ...
    paragraphs:
      - 'Saccharomyces cerevisiae var. boulardi – 100 mg/1 mld. UFC; capsula: hidroxipropilmetilceluloză; agenți de încărcare: amidon din porumb, hidroxipropilceluloză; Lactobacillus rhamnosus GG – 25 mg/4 mld. UFC; agenți antiaglomeranți: săruri de magneziu ale acizilor grași vegetali.'
  ...
  - component: 'usage'
    ...
    paragraphs:
      ...
      - 'Deoarece produsul conține microorganisme vii, nu trebuie combinat cu băuturi sau alimente foarte fierbinți (peste 50°C), foarte reci sau cu alcool etilic.'
